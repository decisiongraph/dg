...
- **Responsible**: richard (CEO, algorithm creator)
- **Approvers**: Erlich Bachman (incubator owner, 10% equity holder)
- **Consulted**: Big Head (friend at Hooli), jared (potential employee)
- **Informed**: dinesh, gilfoyle (potential co-founders)
...
1. **Algorithm integrity**: Richard believed Hooli would ruin middle-out by forcing it into their bloated Nucleus project
2. **Vision alignment**: Peter Gregory understood the technology's potential and offered mentorship without micromanagement
3. **Team consideration**: Accepting Peter's offer allowed bringing on Dinesh, Gilfoyle, and Jared as founding team members
4. **Long-term upside**: $4M seed valuation with potential for much larger Series A if successful
...
### Follow-up Actions
- [x] Sign term sheet with Raviga Capital
- [x] Notify Gavin Belson of rejection
- [x] Begin hiring process for engineering team
- [x] File patent applications for middle-out algorithm
- [x] Move operations to Erlich's incubator full-time
