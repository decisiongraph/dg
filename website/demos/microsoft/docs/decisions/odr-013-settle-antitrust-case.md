...
1. **Closure** — 21-year saga ended (consent decree expired 2011)
2. **Focus restored** — Leadership could focus on business
3. **Enterprise pivot** — STR-002 accelerated
4. **Regulatory relationships** — Brad Smith became industry statesman
5. **Stock stability** — Removed litigation overhang

### Negative

1. **Innovation constraints** — Consent decree limited product decisions
2. **Competitive hesitation** — Fear of antitrust haunted company
3. **Mobile caution** — May have contributed to iPhone response failure
4. **Lost decade narrative** — Stock stagnation blamed partly on case
