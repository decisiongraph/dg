...
### The "Email" Exchange
**Prosecutor Boies**: "You wrote this email, correct?"
**Gates**: "I'm not sure what you mean by 'wrote.'"
...
1. **Legal overpreparation** — Lawyers optimized for wrong format
2. **Client ego** — Gates believed he could outsmart prosecutors
3. **Underestimating opposition** — David Boies was a master litigator
4. **Format blindness** — Didn't anticipate video release
...
1. **Always prepare for worst-case format** — Assume everything is on camera
2. **Executive depositions are high-risk** — Consider alternatives
3. **Authenticity beats cleverness** — Evasion looks terrible on video
4. **Legal strategy ≠ PR strategy** — What wins in court may lose in media
